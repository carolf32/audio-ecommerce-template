...
export const HeadphonesPage = () => {
  const { products } = useProducts("headphones");
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-1 m-4">
        <p className="text-sm">Find the perfect sound</p>
        <h2 className="font-semibold text-xl pb-3">Headphones</h2>
      </div>
      ...
      {/* <div className="flex justify-between items-center m-4">
        ...
        <div className="hover:text-green-default cursor-pointer">Cheapest</div>
