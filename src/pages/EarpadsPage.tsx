...
export const EarpadsPage = () => {
  const { products } = useProducts("earpads");
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-1 m-4">
        <p className="text-sm">Confort guaranteed</p>
        <h2 className="font-semibold text-xl pb-3">Earpads</h2>
      </div>
      ...
      {/* <div className="flex justify-between items-center m-4">
        ...
        <Link to="/earpads" className="hover:text-green-default cursor-pointer">
          See All
        </Link>
      </div> */}
